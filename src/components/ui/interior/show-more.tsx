    ...
    >
      <div className="relative">
        <motion.div
          ...
          className="overflow-hidden overscroll-contain rounded-[6px] outline-none focus-visible:bg-primary/10 focus-visible:shadow-[inset_0_0_0_1px_hsl(var(--primary))]"
        >
      ...
      <div className="mt-2 flex h-8 items-center">
        ...
        <button
          ...
          className={`inline-flex h-8 select-none items-center gap-2 rounded-[9px] border border-border bg-card px-2.5 text-[12.5px] font-medium text-foreground outline-none transition-[border-color,box-shadow] duration-150 hover:border-foreground/30 focus-visible:border-primary focus-visible:shadow-[0_1px_2px_rgba(28,25,23,0.08),0_10px_20px_-14px_rgba(69,104,255,0.6)](147,176,255,0.5)] ${
